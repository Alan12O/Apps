    ...
    return (
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-xl overflow-hidden animate-in fade-in slide-in-from-bottom-8 duration-500 p-8 md:p-12 mb-12">
            ...
            <div className="prose prose-lg text-gray-700 max-w-none space-y-6">
                ...
                <h3 className="text-xl font-bold text-gray-900 mt-8 mb-3">5. Facultad Unilateral de Moderación y Remoción</h3>
                <p>Nuestra plataforma constituye un servicio privado de alojamiento de datos (hosting). Por ende, los administradores del sitio se reservan el derecho absoluto, unilateral y discrecional de remover, eliminar u ocultar de manera definitiva cualquier publicación, imagen o comentario, en cualquier momento y sin necesidad de requerimiento legal o judicial, ni previo aviso al autor original. El uso del sitio implica la aceptación tácita e incondicional de estas reglas internas de moderación.</p>
