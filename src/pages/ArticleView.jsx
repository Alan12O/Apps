            ...
            {isTransitioning || isLoadingFromUrl ? (
                ...
                <>
                    ...
                    {relatedArticles.length > 0 && (
                        <div className="mt-16 pt-10 border-t-4 border-gray-100 mb-12 px-6 pb-6 bg-white rounded-xl shadow-xl overflow-hidden animate-in fade-in slide-in-from-right-8 duration-500">
                            <h3 className={`text-2xl font-bold ${ntrText} mb-8 flex items-center gap-2`}>
                                Últimas noticias
                            </h3>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {relatedArticles.map(article => (
                                    <ArticleCard
                                        ...
                                        canManageArticle={() => false} // Evitamos editar desde la tarjeta de sugerencias
                                        handleEdit={() => { }}
                                        handleDelete={() => { }}
                                    />
                                ))}
